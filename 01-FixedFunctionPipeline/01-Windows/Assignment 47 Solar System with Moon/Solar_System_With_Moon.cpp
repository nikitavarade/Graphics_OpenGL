...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	HWND hwnd;
	MSG msg;
	TCHAR szAppName[] = TEXT("Solar System with Moon");
	int iRet = 0;
	bool bDone = false;
...
void display(void)
{
	...
	quadric = gluNewQuadric();
	glColor3f(0.4f, 0.9f, 1.0f); //Earth
