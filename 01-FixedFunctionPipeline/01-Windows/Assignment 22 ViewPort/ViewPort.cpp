...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		case 0x30:
			i = 0;
			glViewport(0, 0, (GLsizei)width , (GLsizei)height);		//Original
			break;

		case VK_NUMPAD1:
		case 0x31:
			i = 1;
			glViewport(0, 0, (GLsizei)width/2, (GLsizei)height/2);		//Left Bottom
		...
		case 0x32:
			i = 2; 
			glViewport(width/2, 0, (GLsizei)width/2, (GLsizei)height/2);		//Right Bottom
		...
		case 0x33:
			i = 3;
			glViewport(0, height/2, (GLsizei)width/2, (GLsizei)height/2);		//Left Top
			break;

		case VK_NUMPAD4:
		case 0x34:
			i = 4;
			glViewport(width/2, height/2, (GLsizei)width/2, (GLsizei)height/2);		//Right Top
			break;
		...
		case 0x36:
			i = 6;
			glViewport(width/2, 0, (GLsizei)width/2, (GLsizei)height);		//Right Half
		...
		case 0x37:
			i = 7;
			glViewport(0, height/2, (GLsizei)width, (GLsizei)height/2);		//Top Half
			break;
		...
		case 0x39:
			i = 9;
			glViewport(width/4, height/4, (GLsizei)width/2, (GLsizei)height/2);		//Center
