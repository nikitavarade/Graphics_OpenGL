...
void display(void)
{
	...
	glVertex2f(0.0f, 0.1f);//a
	glVertex2f(0.2f, 0.2f);//c
	glVertex2f(0.2f,0.1f);//c
	glVertex2f(0.5f,0.3f);//d
	glVertex2f(1.0f,-0.1f);//e
	glVertex2f(0.7f,0.0f);//f//g
	glVertex2f(0.6f,-0.2f);//g
	glVertex2f(0.5f, -0.1f);//h
	glVertex2f(0.4f,-0.3f);//i
	glVertex2f(0.35f,-0.25f);//j
	glVertex2f(0.0f,-0.5f);//k
	
	glVertex2f(-0.35f, -0.25f);//j-l
	glVertex2f(-0.4f, -0.3f);//i-m
	glVertex2f(-0.5f, -0.1f);//h-n
	glVertex2f(-0.6f, -0.2f);//g-o
	glVertex2f(-0.7f, 0.0f);//f//g-p
	glVertex2f(-1.0f, -0.1f);//e-q
	glVertex2f(-0.5f, 0.3f);//d-r
	glVertex2f(-0.2f, 0.1f);//c-s
	glVertex2f(-0.2f, 0.2f);//c-t

	glVertex2f(-0.0f,0.1f);//a-u
	...
	for (angle = 0.0f; angle < 2.0 * 3.14; angle = angle + 0.000001)
	{
		glVertex3f((GLfloat)cos(angle), (GLfloat)sin(angle), 0.0f);
		//glVertex3f((GLfloat)cos(angle) * 1 + Ox + 0.02, (GLfloat)sin(angle) * 1 + Oy, 0.0f);
