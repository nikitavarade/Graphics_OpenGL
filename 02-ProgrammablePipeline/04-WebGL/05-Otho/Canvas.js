...
//to stop animation: To have cancelAnimationFrame() to be called crossed browser compatible
...
function init()
{
	...
	if(gl.getShaderInfoLog(vertexShaderObject,gl.COMPILE_STATUS)==false);
	{
...
function keyDown(event)
{
	...
	switch(event.keyCode)
	{
		...
		case 27: //Escape
			...
			//To close our application tab
			window.close();//may not work in firefox but works in Safari and google chrome
			break;
